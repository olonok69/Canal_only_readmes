...
| **Azure AI** | Azure AI Foundry Agent | Aplicación Python que demuestra la integración con Azure AI Foundry Agent Service para pronósticos automatizados de producción de trigo con generación comprehensiva de reportes markdown | [📖 Español](Azure/AI_Foundry/Readme_es.md) |
| **Azure Multi-Agente** | Solución Multi-Agente | Sistema de agentes conectados de grado empresarial para procesamiento complejo de tickets con sub-agentes especializados para triaje, análisis técnico y comunicación con clientes usando Azure AI Foundry | [📖 Español](Azure/multi-agent-solution/readme_es.md) |
| **NVIDIA GPU Computing** | Feature Engineering con Aceleración GPU | Pipeline de machine learning de alto rendimiento usando el ecosistema RAPIDS (cuDF, cuML) para procesamiento de datos tabulares con mejoras de rendimiento de 100x+ sobre enfoques tradicionales de CPU | [📖 Español](Nvidia/Feature-Engineering-for-Tabular-Data-With-GPU-Acceleration/Readme_es.md) |
...
| **Estrategia Trading** | Estrategia Bollinger-Fibonacci | Estrategia avanzada que combina análisis de volatilidad (Bandas de Bollinger) con niveles de retroceso de Fibonacci para puntos de entrada/salida precisos | [📖 Español](RAG/bollinger-fibonacci_retracements/Readme_es.md) |
| **Estrategia Trading** | Estrategia Connors RSI | Oscilador de momentum mejorado con integración LangGraph para señales avanzadas de reversión a la media | [📖 Español](RAG/connor-rsi/Readme_es.md) |
| **Estrategia Trading** | Estrategia MACD-Donchian | Combinación de momentum y ruptura usando señales MACD con análisis de Canal de Donchian | [📖 Español](RAG/macd_downchain%20startegy/Readme_es.md) |
| **Estrategia Trading** | Cruce de Medias Móviles Dual | Estrategia institucional clásica que presenta señales de Cruce Dorado/Cruce de la Muerte con análisis y puntuación potenciados por IA | [📖 Español](RAG/Dual%20Moving%20Average%20Crossover%20Strategy/Readme_es.md) |
| **Neo4j RAG** | Sistema RAG Neo4j | Interfaz de lenguaje natural para bases de datos de grafos que permite exploración conversacional de datos y análisis de relaciones complejas | [📖 Español](RAG/speak%20with%20your%20Graph%20Database/Readme_es.md) |
| **Cliente MCP** | Cliente de Análisis Financiero MCP | Cliente MCP integral con herramientas de análisis financiero y soporte multi-servidor | [📖 Español](mcp/mcp-client/Readme_es.md) |
...
| **Herramientas MCP** | Copiloto de Herramientas Neo4j MCP | Generador profesional de reportes Neo4j para análisis de eventos con seguimiento comprehensivo de visitantes, análisis de sesiones e inteligencia cross-event | [📖 Español](mcp/tools-mcp-neo4j-tools-copilot/Readme_es.md) |
...
| **Cliente MCP** | Cliente/Servidor Python MCP | Implementación de referencia Python para cliente/servidor MCP (STDIO/SSE/HTTP) con ejemplos de herramientas y flujo end‑to‑end | [📖 Español](mcp/python_client_server/README_es.md) |
