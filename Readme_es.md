...
| **Estrategia Trading** | Estrategia Bollinger-Fibonacci | Estrategia avanzada que combina análisis de volatilidad (Bandas de Bollinger) con niveles de retroceso de Fibonacci para puntos de entrada/salida precisos | [📖 Español](RAG/bollinger%20fibonacci%20strategy/Readme_es.md) |
| **Estrategia Trading** | Estrategia Connors RSI | Oscilador de momentum mejorado con integración LangGraph para señales avanzadas de reversión a la media | [📖 Español](RAG/connors%20rsi%20startegy/Readme_es.md) |
| **Estrategia Trading** | Estrategia MACD-Donchian | Combinación de momentum y ruptura usando señales MACD con análisis de Canal de Donchian | [📖 Español](RAG/MACD_Donchian/Readme_es.md) |
| **Estrategia Trading** | Cruce de Medias Móviles Dual | Estrategia institucional clásica que presenta señales de Cruce Dorado/Cruce de la Muerte con análisis y puntuación potenciados por IA | [📖 Español](RAG/bollinger%20RAG/Dual%20Moving%20Average%20Crossover%20Strategy/Readme_es.md) |
| **Neo4j RAG** | Sistema RAG Neo4j | Interfaz de lenguaje natural para bases de datos de grafos que permite exploración conversacional de datos y análisis de relaciones complejas | [📖 Español](RAG/Neo4j_RAG/Readme_es.md) |
