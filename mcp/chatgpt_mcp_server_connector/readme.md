...
For higher fidelity views, see the architecture diagrams in `docs/`:
- [ChatGPT connector architecture](docs/mcp-architecture-diagram-chatgpt.svg)
- [Complete multi-tenant architecture](docs/mcp-architecture-diagram-complete.svg)
